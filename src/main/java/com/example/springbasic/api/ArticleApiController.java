...
import com.example.springbasic.service.ArticleService;
...
public class ArticleApiController {
    @Autowired //DI, get the object made and link
    ...
    public ResponseEntity<Article> create(@RequestBody ArticleForm dto) { //u should add RequestBody Annotation
